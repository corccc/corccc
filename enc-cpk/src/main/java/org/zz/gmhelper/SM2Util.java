...
public class SM2Util extends GMBaseUtil {
    ...
    public static BCECPrivateKey convertBCECPrivateKey(byte[] d) {
        ECParameterSpec parameterSpec = new ECParameterSpec(CURVE, G_POINT, SM2_ECC_N, SM2_ECC_H);
        ECPrivateKeySpec ecPrivateKeySpec = new ECPrivateKeySpec(new BigInteger(1, d), parameterSpec);
        return new BCECPrivateKey("EC", ecPrivateKeySpec, BouncyCastleProvider.CONFIGURATION);
    }

    public static BCECPublicKey convertBCECPublicKey(byte[] xy65) {
        byte[] x = new byte[32];
        byte[] y = new byte[32];
        System.arraycopy(xy65,1, x,0,32);
        System.arraycopy(xy65,1 + 32, y,0,32);
        ECParameterSpec parameterSpec = new ECParameterSpec(CURVE, G_POINT, SM2_ECC_N, SM2_ECC_H);
